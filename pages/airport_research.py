...
discard_stale_weatherman_modules("10.7.4")
    ...
    with Session() as session:
        return {
            "forecasts": read_archive_live(
                Forecast,
                session.bind,
                filters={"airport": airport_codes, "horizon": "D-1"},
                minimums={"target_date": earliest_target},
            ),
            "actuals": read_archive_live(
                DailyActual,
                session.bind,
                filters={"airport": airport_codes},
                minimums={"target_date": earliest_target},
            ),
            "observations": read_archive_live(
                ...
                session.bind,
                filters={"airport": airport_codes},
                minimums={"observed_at": earliest_observation},
            ),
        ...
        data.update(
            {
                ...
                "strategies": read_archive_live(
                    StrategySnapshot,
                    session.bind,
                    filters={"airport": airport_codes},
                    minimums={"target_date": earliest_target},
                ),
                "shadows": read_archive_live(
                    ShadowEvaluation,
                    session.bind,
                    filters={"airport": airport_codes},
                    minimums={"target_date": earliest_target},
                ),
                "baskets": read_archive_live(
                    BasketSnapshot,
                    session.bind,
                    filters={"airport": airport_codes},
                    minimums={"target_date": earliest_target},
